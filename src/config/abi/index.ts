...
import SolidlyVoterJson from './solidlyVoter.json';
import SolidlyGaugeJson from './solidlyGauge.json';
...
import BeefyZapRouterJson from './BeefyZapRouter.json';
...
export const SolidlyVoterAbi = SolidlyVoterJson as AbiItem[];
export const SolidlyGaugeAbi = SolidlyGaugeJson as AbiItem[];
export const OneInchPriceOracleAbi = OneInchPriceOracleJson as AbiItem[];
export const BeefyZapRouterAbi = BeefyZapRouterJson as AbiItem[];
