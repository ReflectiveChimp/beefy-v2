import { type ComponentPropsWithoutRef, forwardRef, memo, type ReactNode } from 'react';
...
export const BaseInput = memo(
  forwardRef<HTMLInputElement, BaseInputProps>(function BaseInput(
    {
      startAdornment,
      endAdornment,
      className,
    ...
    return (
      <div {...recipeProps} className={cx('BaseInput-root', classes.root, className)}>
